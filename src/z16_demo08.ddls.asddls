...
define view entity Z16_DEMO08
  as select from /dmo/connection

    association [1..1] to  /dmo/carrier    as _Carrier //[1..1] gibt die connection von carrier zu flügen aus und diese ist immer min 1 und max 1
